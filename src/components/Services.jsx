  ...
  return <Section className="flex column j-center a-center gap">
    <div className="title-container flex column gap-1">
        ...
        <div className="subtitle text-center subdue">
            <h2>Market Watchman has a variety of features that make it the best place to start trading</h2>
        </div>
    </div>
    <div className="services flex j-center a-center gap">
        {servicesData.map(({image,title,descrption})=>{
            return (
                <div className="services text-center flex column gap-1" key={title}>
                    <div className="image">
